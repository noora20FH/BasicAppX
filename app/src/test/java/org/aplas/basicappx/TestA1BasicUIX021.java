...
public class TestA1BasicUIX021 extends ViewTest {
    ...
    public void check_01_String_Resources() {
        rsc.testStringResource("app_name","UnitConverter");
        rsc.testStringResource("tv1Text","UnitConverter");
    ...
    public void check_02_Color_Resources() {
        rsc.testColorResource("purple_200", -4487428);
        rsc.testColorResource("purple_500", -10354450);
        rsc.testColorResource("purple_700", -13172557);
        rsc.testColorResource("teal_200", -16524603);
        rsc.testColorResource("teal_700", -16676986);
        rsc.testColorResource("black", -16777216);
        rsc.testColorResource("white", -1);
